...
/*Another system that implements ISubject can create such an IObserver interface to 
 * define similar method to the method below to call respective classes/departments
 */

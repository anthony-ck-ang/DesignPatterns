...
import com.anthonyang.concreteStrategy.WordsThatStartWithA;
...
public class Context {
	...
	public void changeStrategyByType(StrategyType strategyType) {
		...
		if (strategyType == StrategyType.WORDS_THAT_START_WITH_A) {
			this.strategy = new WordsThatStartWithA();
		}
	}
	...
	public static void main(String[] args) throws IOException {
		...
		// Words thats starts with 'A'
		context.changeStrategyByType(StrategyType.WORDS_THAT_START_WITH_A);
		context.filter(filename);
